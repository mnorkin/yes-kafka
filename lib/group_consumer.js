...
GroupConsumer.prototype._topics = function (members) {
  return [].concat.apply([], members.map(function (member) { return member.subscriptions; }));
};
...
GroupConsumer.prototype._syncGroup = function () {
  ...
  return Promise.try(function () {
    if (self.memberId === self.leaderId) { // leader should generate group assignments
      const topics = self._topics(self.members);
...
GroupConsumer.prototype.commitOffset = function (commits) {
  ...
  return self.client.offsetCommitRequestV2(
